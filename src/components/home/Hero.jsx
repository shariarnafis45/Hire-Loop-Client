...
// Import your purely JSX motion wrappers
import { FadeUpWrapper, StaggerContainer, StaggerItem, AnimatedCounter } from "@/components/animation/MotionWrappers";
...
// Split value into numeric and suffix for the AnimatedCounter
const statsData = [
  { numericValue: 50, suffix: "K", label: "Active Jobs", icon: <FiBriefcase size={22} /> },
  {
    numericValue: 12,
    suffix: "K",
    label: "Companies",
  ...
  { numericValue: 2, suffix: "M", label: "Job Seekers", icon: <FiActivity size={22} /> },
  { numericValue: 97, suffix: "%", label: "Satisfaction Rate", icon: <FiStar size={22} /> },
];
      ...
      <div className="relative mx-auto max-w-[1180px] px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <FadeUpWrapper delay={0.1}>
            {/* Top Badge (Glassy) */}
            <div className="inline-flex items-center gap-2.5 px-3 py-1.5 rounded-full border border-white dark:border-white/[0.08] bg-white/60 dark:bg-white/[0.02] backdrop-blur-md shadow-sm mb-8 transition-all hover:scale-105 duration-300">
          ...
          <FadeUpWrapper delay={0.4} className="w-full max-w-[760px] mb-8">
            {/* The Ultimate Glass Search Bar */}
            <div className="w-full p-2 rounded-2xl border border-white dark:border-white/[0.08] bg-white/70 dark:bg-[#0a0a0c]/80 backdrop-blur-2xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.8)] flex flex-col md:flex-row items-center gap-1 transition-all">
              {/* Input 1 */}
              <div className="flex-1 flex items-center px-4 py-2.5 w-full group">
                <FiSearch
                  className="text-zinc-400 dark:text-zinc-500 mr-3 shrink-0 group-focus-within:text-indigo-500 transition-colors"
                  size={18}
                />
                <input
                  type="text"
          ...
          <FadeUpWrapper delay={0.5}>
            {/* Trending Tags (Frosted Glass) */}
            <div className="flex flex-wrap justify-center items-center gap-3">
              <span className="text-[12px] font-semibold text-zinc-500 dark:text-zinc-500 tracking-wide">
                Trending Position:
              </span>
        ...
        <div className="relative w-full h-[320px] flex flex-col items-center justify-end overflow-visible mt-16 mb-8">
          <FadeUpWrapper delay={0.1} className="absolute inset-0 flex justify-center w-full">
            {/* Glassy Globe Arc */}
            <div className="absolute top-1/4 w-[180%] sm:w-[130%] max-w-[2000px] aspect-square rounded-full border border-indigo-600/10 dark:border-indigo-500/20 bg-gradient-to-b from-white/40 to-transparent dark:from-[#060608]/80 dark:to-transparent backdrop-blur-[2px] shadow-[0_-20px_60px_rgba(79,70,229,0.05)] dark:shadow-[0_-40px_100px_rgba(99,102,241,0.15)] pointer-events-none transition-all duration-500 z-0">
          ...
          <FadeUpWrapper delay={0.3}>
            ...
            <div className="relative text-center z-10 px-4 pb-4">
              <h2 className="text-2xl sm:text-[32px] font-bold tracking-tight text-zinc-800 dark:text-zinc-200 mb-1.5 transition-colors">
                Assisting over{" "}
                <span className="text-indigo-600 dark:text-white font-extrabold drop-shadow-sm">
                  15,000 job seekers
                </span>
              </h2>
        ...
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 relative z-10">
              ...
              >
                ...
                <div className="flex flex-col items-start mt-auto relative z-10">
                  <span className="text-[44px] font-black tracking-[-0.02em] text-zinc-900 dark:text-white leading-none mb-2.5 select-none transition-colors">
                    {/* Animated Number Logic Applied Here */}
