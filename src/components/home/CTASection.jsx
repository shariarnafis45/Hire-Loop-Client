const CTASection = () => {
  return (
    <section className="relative w-full bg-[#f8fafc] dark:bg-[#030303] pt-40 pb-32 overflow-hidden font-sans transition-colors duration-500 flex flex-col items-center justify-center text-center">
      ...
      <div className="absolute top-[10%] left-1/2 -translate-x-1/2 w-[250%] sm:w-[160%] lg:w-[120%] max-w-[2000px] aspect-[2/1] rounded-t-[100%] border-t border-indigo-600/15 dark:border-indigo-500/40 bg-gradient-to-b from-indigo-100/40 via-transparent to-transparent dark:from-indigo-900/30 dark:via-transparent dark:to-transparent pointer-events-none transition-all duration-500">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 flex flex-col items-center mt-8">
        ...
        {/* Subtitle */}
        <p className="text-[16px] sm:text-[18px] text-zinc-600 dark:text-zinc-400 font-medium mb-10 max-w-[540px] leading-relaxed transition-colors duration-500">
