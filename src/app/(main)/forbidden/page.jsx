...
const ForbiddenPage = () => {
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-[#030303] flex items-center justify-center p-4 relative overflow-hidden font-sans transition-colors duration-500">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-red-500/[0.02] dark:bg-amber-500/[0.02] blur-[140px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto">
        ...
        <div className="relative bg-white dark:bg-[#09090b]/40 backdrop-blur-xl border border-neutral-200/60 dark:border-white/[0.06] rounded-[32px] p-8 sm:p-12 shadow-[0_24px_50px_-12px_rgba(0,0,0,0.02)] dark:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)] overflow-hidden text-center">
          ...
          {/* Forbidden Warning Badge */}
          <div className="inline-flex items-center gap-1.5 bg-red-500/10 dark:bg-amber-400/[0.05] border border-red-500/20 dark:border-amber-400/20 text-red-800 dark:text-amber-400 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest mb-8 select-none">
            <ShieldX size={11} />
            403 Forbidden
          </div>

          {/* Luxury Lock Icon */}
          <div className="relative w-20 h-20 bg-neutral-100 dark:bg-amber-400/[0.03] text-neutral-800 dark:text-amber-400 rounded-full flex items-center justify-center mx-auto border border-neutral-200 dark:border-amber-400/10 mb-8 shadow-inner">
            <Lock size={28} strokeWidth={1.5} />
            {/* Soft ping effect for the forbidden state */}
            <div className="absolute inset-0 border border-neutral-300 dark:border-amber-400/20 rounded-full animate-ping opacity-10"></div>
          </div>
          ...
          <div className="space-y-3 mb-10">
            ...
            <p className="text-neutral-500 dark:text-zinc-400 text-sm font-medium leading-relaxed max-w-sm mx-auto">
              Your identity verified successfully, but your account lacks the administrative clearance levels required to cross into this sector.
            </p>
          </div>
