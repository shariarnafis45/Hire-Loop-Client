...
export default function RecruiterNewJobPostForm({ company }) {
  ...
  return (
    <div className="relative max-w-4xl mx-auto pb-12">
      ...
      {/* Context Banner */}
      <div className="flex items-start sm:items-center justify-between gap-4 p-5 rounded-[1.5rem] bg-gradient-to-r from-indigo-50/80 to-blue-50/80 dark:from-indigo-900/20 dark:to-blue-900/20 border border-indigo-100/50 dark:border-indigo-800/30 backdrop-blur-md shadow-sm mb-6">
      ...
      {companyData.status === "pending" ? (
        <motion.div
          ...
          className="max-w-xl mx-auto mt-8 relative bg-white/60 dark:bg-[#09090b]/40 backdrop-blur-xl border border-neutral-200/60 dark:border-white/[0.06] rounded-[2.5rem] p-8 md:p-12 text-center shadow-[0_24px_60px_-15px_rgba(0,0,0,0.05)] dark:shadow-[0_30px_70px_-15px_rgba(0,0,0,0.6)] overflow-hidden"
        >
          {/* Ambient Glowing Background Orb */}
          <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-48 h-48 bg-amber-500/10 dark:bg-amber-400/[0.04] blur-3xl rounded-full pointer-events-none" />

          {/* Luxury Icon Badge with Ripple Pulse Effect */}
          <div className="relative w-20 h-20 mx-auto mb-8 flex items-center justify-center">
            <div className="absolute inset-0 bg-amber-500/10 dark:bg-amber-400/5 rounded-[2rem] animate-pulse border border-amber-500/20 dark:border-amber-400/10" />
            <div className="absolute inset-2 bg-amber-500/[0.05] dark:bg-amber-400/[0.02] rounded-[1.5rem] animate-ping opacity-40 duration-1000" />
            <div className="relative w-14 h-14 bg-gradient-to-br from-amber-500/10 to-amber-600/20 text-amber-600 dark:text-amber-400 rounded-2xl flex items-center justify-center border border-amber-500/30 dark:border-amber-400/20 shadow-inner">
          ...
          <div className="space-y-3 max-w-sm mx-auto">
            ...
            <p className="text-sm font-medium text-neutral-500 dark:text-zinc-400 leading-relaxed">
              Our team is currently reviewing your company profile for{" "}
              <span className="text-amber-600 dark:text-amber-400 font-bold">
                {companyData.name}
              </span>
              . This secure process typically takes less than 24 hours.
            </p>
          </div>

          {/* Micro Timeline Indicator */}
          <div className="mt-8 p-4 bg-neutral-50/80 dark:bg-[#121214]/50 border border-neutral-200/40 dark:border-white/[0.04] rounded-2xl flex items-center gap-4 text-left">
            ...
            <div>
              ...
              <p className="text-[11px] font-medium text-neutral-400 dark:text-zinc-500 mt-0.5">
                Once approved, you'll instantly unlock full feature leverage to
                post premium roles.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            <Link
              ...
              className="flex-1 h-12 inline-flex items-center justify-center rounded-xl bg-neutral-900 hover:bg-neutral-800 dark:bg-white dark:hover:bg-zinc-100 text-white dark:text-black text-xs font-bold uppercase tracking-wider transition-all shadow-sm"
            >
              Go to Dashboard
            </Link>
            <Link
              href={`/dashboard/recruiter/companies`}
              className="flex-1 h-12 inline-flex items-center justify-center rounded-xl bg-neutral-100 hover:bg-neutral-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 border border-neutral-200/60 dark:border-zinc-800 text-neutral-700 dark:text-zinc-300 text-xs font-bold uppercase tracking-wider transition-all"
            >
              View Profile
            </Link>
          </div>
